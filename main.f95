PROGRAM host_atoms 
  ...
  ! 2a) The subroutine host_atoms return the information of all host atoms for analysis. That is a 3D-array of shape (3,T,N),
  ! where 3 means there are 3 coordinates in space, T is the total steps of the reduced trajectory obtained from sampling, and N is
  ! the total number of the host atoms R. We store the 3D-array as a linked list.
